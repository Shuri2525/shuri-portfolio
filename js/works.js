...
,
  ...
  "detailText": "「新装」の意味を軸に、若さ・成長・未来への広がりを表現しました。角ばった建設ロゴではなく、円形基調で調和と安心感を設計。カラーはグリーンを主軸にブルーを添え、誠実さと若々しさを両立しています。印刷用途では再現性を優先してベタ配色、WEB・SNSでは表現幅としてグラデーションを展開しています。"
}
