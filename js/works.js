...
,
  ...
  "detailText": "縦型名刺の端正さを軸に、情報は横書きで整理して視線移動をスムーズに設計しました。ロゴ案件とトーンを揃えながら、実務で扱いやすい明瞭な情報階層にまとめています。入稿データ作成から納品まで一貫して対応しています。"
}
,
  {
  "id": "02",
  ...
  "detailText": "観音開きの特性を活かし、説明の流れが自然につながる情報設計に整えました。専門的な内容でも読みやすさを保てるよう、配色と要素配置を整理し、安心感とデザイン性の両立を意識しています。入稿データ作成から納品まで一貫して対応しています。"
}
,
  ...
  "detailText": "物件情報が主役として伝わるよう情報を整理し、視線が迷わない紙面構成に整えました。更新頻度の高い運用を想定し、配色を切り替えて展開できる設計で、統一感と更新性を両立しています。マップやQRの素材準備、物件撮影を含め、入稿データ作成から納品まで一貫して対応しました。"
}
,
    {
  "id": "05",
  ...
  "detailText": "複雑に見えがちな土地活用の内容を、情報の順序と見出し設計で読み解きやすく整理しました。マスコットキャラクターを要所に配置し、安心感と親しみやすさを補強。問い合わせ導線を明確にし、初回相談へつながる構成に整えています。入稿データ作成から納品まで一貫して対応しました。"
}
  ],
  ...
  "outline": "大分市の鉄骨建設事業向けに制作した実案件ロゴです。末広がりの意味を持つ「8」をモチーフに、丸みのある造形で親しみと成長性を両立させました。",
  "target": "大分市 / 鉄骨・建設事業",
  "period": "10〜12日",
  "purpose": "企業の発展性と信頼感を、媒体をまたいで一貫して伝えるため",
  "designAxis": "象徴性 / 媒体適応 / 親和性",
  "detailText": "「新創」の意味を軸に、成長と未来への広がりを表現しました。角ばった建設ロゴではなく、円形基調で調和と安心感を設計。カラーはグリーンを主軸にブルーを添え、誠実さと先進性を両立しています。印刷用途では再現性を優先してベタ配色、WEB・SNSでは表現幅としてグラデーションを展開しています。<br><span class=\"detail-note\">本ロゴ制作先企業のInstagram：<a href=\"https://www.instagram.com/sinso_kensetsu31/?hl=ja\" target=\"_blank\" rel=\"noopener noreferrer\">@sinso_kensetsu31</a></span>"
}
