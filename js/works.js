...
,
  ...
  "detailText": "「新創」の意味を軸に、成長と未来への広がりを表現しました。角ばった建設ロゴではなく、円形基調で調和と安心感を設計。カラーはグリーンを主軸にブルーを添え、誠実さと先進性を両立しています。印刷用途では再現性を優先してベタ配色、WEB・SNSでは表現幅としてグラデーションを展開しています。<br><span class=\"detail-note\">本ロゴ制作先企業のInstagram：@sinso_kensetsu31</span>"
}
